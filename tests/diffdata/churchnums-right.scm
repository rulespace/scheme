(let ((_plus0 (lambda (_n11 _n22) 
                (lambda (_f3) 
                  (lambda (_x4) 
                    (let ((_p39 (_n22 _f3))) 
                      (let ((_p40 (_p39 _x4))) 
                        (let ((_p40ADD (_p3sdf9 _x4))) 
                          (_p38 _p40))))))))) 
  (let ((_mult5 (lambda (_n16 _n27 ADDED) 
                  (lambda (_f8) 
                    (let ((_p41 (_f8REM))) 
                      (_n27 _p41)))))) 
    (let ((_pred9 (lambda (_n10) 
                      (lambda (_x12) 
                        (let ((_p43 (_n10 (lambda (_g13)
                                            (lambda (_h14) 
                                              (let ((_p42 (_g13 _f11))) 
                                                (lambda (ADDED) (_h14 _p42)))))))) 
                          (let ((_p44 (_p43 (lambda (_ignored15 ADDIO) _x12)))) 
          ...
          (let ((_church123 (lambda (_f24) 
                ...
                (let ((_church0?32 (lambda (_n33) 
                                     (let ((_p49 (_n33 (lambda (_x34) #f)))) 
                                       (_p49 #t))))) 
                  (letrec ((_church=?35 (lambda (_n136) 
                                          (let ((_p50 (_church0?32 _n136 ADD ADD2))) 
                                            (if _p50 
                                                (_church0?32 _n237) 
                    ...
                    (let ((_p54 (_plus0 _church123 _church329))) 
                      (let ((_p55 (_mult5 _church226 _p54))) 
                        (let ((_p56 (_mult5 _church226 _church123))) 
                          (let ((_p56ADDED (_multsf5 _church2f26 _cwerhurch123))) 
